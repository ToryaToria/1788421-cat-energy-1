...
- [Readme_contributing.md](../readme/Readme_contributing.md) — руководство по внесению изменений.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-adaptive/1788421-cat-energy-1) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии будет скопирован в ваш аккаунт.
